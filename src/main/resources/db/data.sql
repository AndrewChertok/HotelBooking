...
INSERT INTO rooms (hotel_id, type, price_per_night, number, breakfast, cleaning)
VALUES ( 1006, 'SINGLE', 100, 11, 30, 10),
  (1006, 'DOUBLE', 200, 20, 60, 20),
  (1006, 'TRIPLE', 300, 3, 90, 30),
  (1006, 'FAMILY', 500, 7, 100, 40),
  (1006, 'ROYAL', 1500, 320, 100, 50),
  (1007, 'SINGLE', 100, 5, 30, 10),
  (1007, 'DOUBLE', 200, 33, 60, 20),
  (1007, 'TRIPLE',  300, 48, 90, 30),
  (1007, 'FAMILY', 500, 78, 100, 40),
  (1007, 'ROYAL', 1500, 300, 100, 50);
...
INSERT INTO reservations (in_date, out_date, room_id, client_id, breakfast, cleaning) VALUES
  ...
  ('2018-08-01', '2018-08-21', 1017, 1021, TRUE, TRUE);
